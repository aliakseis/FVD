...
Item {
    ...
    QtObject {
        ...
        function initScollbar() {
            ...
            {
                scrollbar.viewSize = flickableItem.height;
                scrollbar.documentSize = flickableItem.contentHeight;
                scrollbar.maximum = flickableItem.contentHeight > flickableItem.height ? flickableItem.contentHeight - flickableItem.height : 0;
                scrollbar.value = flickableItem.contentY;
    ...
    function addPageStep() {
        // dont use the convenience API to trigger the
        // behavior on value specified on rangemodel
        internal.acceptChangeValue = false;
        if (!inverted)
            model.value += model.pageStep;
        else
            model.value -= model.pageStep;
        internal.acceptChangeValue = true;
    }
    ...
    Rectangle  {
        ...
        BorderImage {
            ...
            MouseArea {
                ...
                onPressed: { internal.acceptChangeValue = false; }
                onReleased: { internal.acceptChangeValue = true; }
            }
    ...
    Image {
        ...
        Timer {
            ...
            onTriggered: { internal.acceptChangeValue = false; subSingleStep(); internal.acceptChangeValue = true; }
        }
    ...
    Image {
        ...
        Timer {
            ...
            onTriggered: { internal.acceptChangeValue = false; addSingleStep(); internal.acceptChangeValue = true; }
        }
...
//        }
        onValueChanged: {
            if( !internal.acceptChangeValue )
            {
                flickableItem.contentY = scrollbar.value + scrollbar.bugWorkaround;
            }
        }
        singleStep: 1
        pageStep: 10
