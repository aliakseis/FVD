...
MainToolBar::MainToolBar(QWidget* parent) :
	QWidget(parent),
	m_activeTabIndex(SEARCH_TAB),
	ui(new Ui::MainToolBar)
{
	ui->setupUi(this);
	std::pair<TabId, QToolButton*> tabsOrder[] =
	{
		std::make_pair(SEARCH_TAB, ui->btnSearch),
...
void MainToolBar::on_btnSettings_clicked()
{
	emit settings();
}
...
int MainToolBar::getCurrTabIndex()
{
