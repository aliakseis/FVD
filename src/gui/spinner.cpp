...
Spinner::Spinner(QWidget* parent) : QLabel(parent), m_currentRotateAngle(0), m_timerId(0)
{
...
bool Spinner::isSpinning() const { return m_timerId != 0; }

void Spinner::setSpinning(bool spin) { spin ? startSpin() : stopSpin(); }
