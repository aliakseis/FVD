	...
	ui(new Ui::LibraryForm)
{
	...
	VERIFY(connect(ui->cbSearch, SIGNAL(returnPressed()), this, SLOT(onSearch())));
...
{
	m_proxyModel->setFilterRegExp(QRegExp(ui->cbSearch->text(), Qt::CaseInsensitive));
}
...
QWidget* LibraryForm::manageWidget() const
{
