...
CustomDockWidget::CustomDockWidget(QWidget* widget) : QDockWidget(widget), m_state(ShownDocked), m_prevState(ShownDocked)
{
...
void CustomDockWidget::setDisplayForFullscreen(VideoDisplay* display)
{
	...
	VERIFY(connect(this, SIGNAL(topLevelChanged(bool)), this, SLOT(onTopLevelChanged(bool))));
}
