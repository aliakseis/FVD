...
macro(INSTALL_QT5PLUGINS TARGET_NAME)
	if(WIN32 OR APPLE)
		...
		set(MISC_LIBS Qt5QuickTemplates2 opengl32sw icuuc49 icuin49 icudt49 icuuc51 icuin51 icudt51 Qt5QmlModels Qt5QmlWorkerScript Qt5QuickParticles Qt5QuickShapes D3DCompiler_43 D3DCompiler_47)
...
macro(INSTALL_QT5QML TARGET_NAME)
	if(WIN32 OR APPLE)
		#message(--------------------------------------INSTALL_QT5QML----------------------------------)
		get_target_property(qtCoreLocation ${Qt5Core_LIBRARIES} LOCATION)
		string(REGEX REPLACE "(bin|lib)/Qt5Core(.*)" "qml/" qtQmlPath ${qtCoreLocation})
